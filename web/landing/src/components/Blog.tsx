...
import { Calendar, User, ArrowRight, Tag, Clock, TrendingUp, BookOpen, Zap, Search, Mail } from 'lucide-react';
...
export const Blog = () => {
  ...
  const categories = [
    ...
    { name: "Best Practices", count: 2, active: false }
  ];
    ...
    <section className="py-20 bg-white">
      <div className="container mx-auto px-4 md:px-6">
        ...
        <motion.div
          ...
          className="text-center"
        >
          <button className="px-8 py-4 bg-slate-100 text-slate-700 font-semibold rounded-lg hover:bg-slate-200 transition-colors">
            Load More Articles
          </button>
        </motion.div>
      </div>
